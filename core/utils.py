...
############### - FOLLOWING FUNCTION WAS CHANGED TO SUPPORT NEW VERSIONS OF OPENCV - ###############
    
def draw_bbox(image, bboxes, class_names=read_class_names(cfg.YOLO.CLASSES), show_label=True):
...
############### - ABOVE FUNCTION WAS CHANGED TO SUPPORT NEW VERSIONS OF OPENCV - ###############
